...
<h1 style="color: #0FB0F6;" class="card-body">AGENDA UNA REUNIÓN CON NOSOTROS</h1>
  ...
  <div class="form-contac">
    <form method="post" action="mailto:biocenter.contactanos@gmail.com">
      ...
      <label for="marca"><b>Marca Vehículo:</b></label>
      ...
      <label for="valor"><b>Valor Estimado:</b></label>
      <input type="number" id="valor" name="valor" required><br><br>

      <fieldset>
          <legend>Uso del VehÍculo:</legend>
          <input type="checkbox" id="personal" name="Uso_vehiculo" value="personal">
          <label for="personal">Personal</label><br>
          <input type="checkbox" id="comercial" name="Uso_vehiculo" value="comercial">
          <label for="comercial">Comercial</label><br>
      </fieldset><br>
        <label for="edificio"><b>Elije tu Seguro:</b></label>
            <select id="edificio" name="edificio">
                <option value="Seguro Automotriz">Seguro Automotriz</option>
                <option value="Seguro Automotriz">Seguro Motocicletas</option>
