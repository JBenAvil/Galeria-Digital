  ...
  <div class="form-contac">
    <form method="post" action="mailto:biocenter.contactanos@gmail.com">
      ...
      <fieldset>
        ...
        <label for="edificio"><b>Elije tu Casa:</b></label>
            <select id="edificio" name="edificio">
                <option value="Conquistadores, Puente Alto">Conquistadores, Puente Alto</option>
                <option value="Townhouse Terralta, Las Condes">Townhouse Terralta, Las Condes</option>
                <option value="Terralta, Colina">Terralta, Colina</option>
                <option value="Santuario del Valle, Las Dehesa">Santuario del Valle, Las Dehesa</option>
                <option value="Las Brisas, Chicureo">Las Brisas, Chicureo</option>
                <option value="Townhouse Flandes, Las Condes">Townhouse Flandes, Las Condes</option>
                <option value="Los Nogales, La Dehesa">Los Nogales, La Dehesa</option>
                <option value="Punta Kai, Punta Sur Playa Pupuya S/N, Matanza">Punta Kai, Punta Sur Playa Pupuya S/N, Matanza</option>
