...
<body>
  ...
  <br>
  <section id=section3>
    <h1 style="color: #0FB0F6;" class="card-body">EDIFICIO FERRER ALTO LOS DOMINICOS</h1>
    <br>
    <h4 class="card-text-decripcion">Edificio Ferrer presenta características de edificación con departamento Simplex y Duplex, cuentan con terrazas con vista norte y una inigualable luz natural.</h4>     <h4 class="card-text-decripcion">Departamentos con moderna arquitectura y magníficas terminaciones.</h4> 
    <h4 class="card-text-decripcion">Es un proyecto donde se mantiene la tradición del barrio, generando una herencia del entorno.</h4>
    <h4 class="card-text-decripcion">Se encuentra en un entorno exclusivo del sector del remanso, Las Condes. Barrio privado con accesos controlados y guardias de seguridad 24/7</h4>
    <br>
    <!-- sección tarjeta edificio y sus caracteristicas -->
    <section id=section3>
      <br>
    ...
    height: 100%;"
                  src="/static_altos_dominicos/ferres_1.jpg"
                  alt="Card image cap">
              <br>
              <h1 style="color: #0FB0F6;" class="card-body"><b>Precios desde 14.360 UF</b></h1>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <div class="card mb-6 box-shadow">
            <div class="card-body">
              <h4 style="color: #0FB0F6;" class="card-text certificate-text"><b>DEPARTAMENTOS FERRER</b></h4><br>
              <p style="text-align: left;">Edificio Ferrer presenta características de edificación con departamento Simplex y Duplex, cuentan con terrazas con vista norte y una inigualable luz natural. Departamentos con moderna arquitectura y magníficas terminaciones.</p>
              <h4 style="color: #0FB0F6;" class="card-text certificate-text"><b>CARACTERÍSTICAS</b></h4><br>
              <ul style="text-align: left;">
                <li>Dormitorio principal en suite.</li>
                <li>Walking closet con luz natural (departamento simplex).</li>
                <li>Cocina con comedor de diario.</li>
                <li>Terraza con parrilla a gas.</li>
                <li>Equipamiento de cocina FDV, encimera a gas, torre de horno + horno microondas, campana decorativa en simplex y campana extraíble en dúplex.</li>
                <li>Vista norte asegurada.</li>
                <li>Pisos orgánicos H2O y de porcelanato.</li>
                <li>Alarma conectada a central de seguridad.</li>
              </ul>            
            </div>
          </div>
        </div>
    ...
    <br>
    <br>
    <!-- sección de imagenes en carrosel -->
    <section>
    <div class="Heading"></div>
    <div class="container certificate">
      <div class="row">
        <div class="col-md-12">
              <div class="card mb-12 box-shadow">
                <div class="card-body">
                  <div id="carouselExampleDark" class="carousel carousel-dark slide">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/2.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/8.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/7.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/5.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/4.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/1.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/6.webp" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                          <img src="https://www.altodominicos.cl/wp-content/uploads/2022/03/3.webp" class="d-block w-100" alt="...">                     
                      </div>
                    </div>
                  ...
                  <br>
                  <p style="text-align: right;"><b>Imágenes Referenciales</b></p>
                </div>
              </div>
        </div>
      </div>
  ...
  <br>
  <br>
  <!-- seccción de contacto -->
  <h4 class="card-text-decripcion"><b>Agenda una reunión personaliza para coordinar una visita a tu futuro departamento, conoce tus ofertas y beneficos para tu nuevo departamento. Descubre como podemos ayudarte para financiar tu nuevo departamento.</b></h4>
  <br>
  <br>
