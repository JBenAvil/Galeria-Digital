  ...
  <div class="form-contac">
    <form method="post" action="mailto:biocenter.contactanos@gmail.com">
      ...
      <input type="tel" id="telefono" name="telefono" required><br><br>
        ...
        <label for="edificio"><b>Elije el Seguro par tu Hogar:</b></label>
            <select id="edificio" name="edificio">
                <option value="Seguro Contenido Hogar">Seguro Contenido Hogar</option>
                <option value="Seguro Contenido y Exteriror">Seguro Contenido y Exteriror</option>
