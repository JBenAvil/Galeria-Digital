...
<h1 style="color: #0FB0F6;" class="card-body">AGENDA UNA REUNIÓN CON NOSOTROS</h1>
  ...
  <div class="form-contac">
    <form method="post" action="mailto:biocenter.contactanos@gmail.com">
      ...
      <label for="apellido"><b>Dirección:</b></label>
      <input type="text" id="dirección" name="dirección" required><br><br>

        <label for="edificio"><b>Elije tu el Seguro de tu Interés:</b></label>
            <select id="edificio" name="edificio">
                <option value="Seguro para supermercados y minimarket">Seguro para supermercados y minimarket</option>
                <option value="Seguro de viajes">Seguro de viajes</option>
                <option value="Seguro para oficinas">Seguro para oficinas</option>
                <option value="Seguro para Veterinarias y Petshop">Seguro para Veterinarias y Petshop</option>
                <option value="Seguro para peluquerías y centros de estética">Seguro para peluquerías y centros de estética</option>
                <option value="Seguro Restaurantes y Cafeterías">Seguro Restaurantes y Cafeterías</option>
